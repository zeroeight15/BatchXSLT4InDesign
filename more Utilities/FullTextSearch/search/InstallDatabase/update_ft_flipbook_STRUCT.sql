/**
 * Migrate from databases with same number of columns (but no PRIMARY KEYs) to the latest version
 */
...
INSERT INTO `objects_MIG` (`view_index`,`object_id`,`company`,`title`,`issue`,`description`,`link`,`language`,`copyright`,`ttl`,`timezone`)
		SELECT * FROM `objects`;
